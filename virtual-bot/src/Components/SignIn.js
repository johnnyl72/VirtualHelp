    ...
    <div className="pt-5 pt-5">
      <div className="container signHtml signBody pt-5">
        <form className="form-signin">
          <img className="mb-4" id="centerlog"  src="https://i.pinimg.com/originals/ba/92/fe/ba92fe11861df19e26a8be133acc5e10.png" alt="" style={{width:"72px", height:"72px", transform: "rotate(.6turn)", filter: "hue-rotate(220deg"}}/>

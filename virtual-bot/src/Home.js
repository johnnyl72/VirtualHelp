...
class Home extends React.Component{
  ...
  <main role="main">
    <div style={{background: "#F0F8FF" , overflowX:"hidden"}}>
      <div className="marketing" style={{paddingTop: "5%", paddingBottom: "18%"}}>
        <div className="row center">
          <div className="col-lg-3">
            <img src="https://cdn.clipart.email/1468a43d9aab498728e693cefdc57f7f_28-collection-of-robot-clipart-transparent-high-quality-free-_2220-2000.png"  style={{width: "96%"}}/>
          </div>
          ...
          <div className="col-lg-3">
            <img src="https://woebot.io/static/app-d427756f065bfa07d4125d9be3d8ee8d.gif" alt="" style={{width: "95%"}}/>
          </div>
        </div>
  ...
  <div id="myCarousel" className="carousel slide" data-ride="carousel">
    ...
    <a className="carousel-control-next" href="#myCarousel" role="button" data-slide="next">
      ...
      <span className="sr-only">Next</span>
        ...
        // <div class>
        //   <div class="col" style={{backgroundColor: "coral", marginT: "auto", padding: 50}}>
        //     <img style={{display: "block", margin: "0 auto"}}src="https://esrc.files.wordpress.com/2019/01/ihelpr.png?w=676" />
        //   </div>
        //   <div class="col mt-5">
        //     <h5 style={{textAlign: "center"}}>Under Construction. We'll be back soon!</h5>
        //   </div>
        // </div>
